...
export type TogglePublishPostMutation = {
  __typename?: 'Mutation';
  togglePublishPost?: {
    __typename?: 'Post';
    id: number;
...
`;
export type IncreasePostViewCountMutationFn = Apollo.MutationFunction<
...
export function useIncreasePostViewCountMutation(
  ...
  return Apollo.useMutation<
    IncreasePostViewCountMutation,
    IncreasePostViewCountMutationVariables
  >(IncreasePostViewCountDocument, options);
}
export type IncreasePostViewCountMutationHookResult = ReturnType<
  typeof useIncreasePostViewCountMutation
>;
export type IncreasePostViewCountMutationResult =
  Apollo.MutationResult<IncreasePostViewCountMutation>;
export type IncreasePostViewCountMutationOptions = Apollo.BaseMutationOptions<
  IncreasePostViewCountMutation,
  IncreasePostViewCountMutationVariables
>;
...
`;
export type TogglePublishPostMutationFn = Apollo.MutationFunction<
  TogglePublishPostMutation,
  TogglePublishPostMutationVariables
>;
 ...
 * });
 */
export function useTogglePublishPostMutation(
  baseOptions?: Apollo.MutationHookOptions<
    TogglePublishPostMutation,
    TogglePublishPostMutationVariables
  >
  ...
  return Apollo.useMutation<
    TogglePublishPostMutation,
    TogglePublishPostMutationVariables
  >(TogglePublishPostDocument, options);
}
export type TogglePublishPostMutationHookResult = ReturnType<
  typeof useTogglePublishPostMutation
>;
export type TogglePublishPostMutationResult =
  Apollo.MutationResult<TogglePublishPostMutation>;
export type TogglePublishPostMutationOptions = Apollo.BaseMutationOptions<
  TogglePublishPostMutation,
  TogglePublishPostMutationVariables
>;
 ...
 * });
 */
export function useDraftsByUserQuery(
  baseOptions: Apollo.QueryHookOptions<DraftsByUserQuery, DraftsByUserQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DraftsByUserQuery, DraftsByUserQueryVariables>(
    DraftsByUserDocument,
    options
  );
}
export function useDraftsByUserLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<DraftsByUserQuery, DraftsByUserQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DraftsByUserQuery, DraftsByUserQueryVariables>(
    DraftsByUserDocument,
    options
  );
}
...
export type DraftsByUserQueryResult = Apollo.QueryResult<
  DraftsByUserQuery,
  DraftsByUserQueryVariables
>;
...
export function usePostByIdQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PostByIdQuery, PostByIdQueryVariables>(
    PostByIdDocument,
    options
  );
}
export function usePostByIdLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PostByIdQuery, PostByIdQueryVariables>(
    PostByIdDocument,
    options
  );
}
...
export type PostByIdQueryResult = Apollo.QueryResult<
  PostByIdQuery,
...
export type StrictTypedTypePolicies = {
  AuthPayload?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | AuthPayloadKeySpecifier
      | (() => undefined | AuthPayloadKeySpecifier);
